...
// Region — субъект РФ по двум первым цифрам ИНН, КПП или по цифрам 4–5
// ОГРН. Коды упразднённых автономных округов (80–82, 84, 85, 88) и
// служебные коды не расшифровываются: для них возвращается пустая строка.
