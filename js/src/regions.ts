// Субъекты РФ по двум первым цифрам ИНН и КПП или по цифрам 4–5 ОГРН.
// Коды упразднённых автономных округов (80–82, 84, 85, 88) и служебные
// коды не расшифровываются.
...
/** Субъект РФ по двузначному коду или пустая строка. */
export const region = (code: string): string => regions[code] ?? "";
